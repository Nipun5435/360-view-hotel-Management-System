...
<body id="page-top" style="text-align: center; ">
    <div id="wrapper">
            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                           ...
                           <a class="nav-link active" href="user.php"><i class="fa fa-user"></i><span>Admins</span></a>
        ...
        <div class="alert alert-primary"><h3>Accounts / Admin</h3></div> 
        <button style="float: right; height: 100px;" class="btn btn-success" data-toggle="modal" data-target="#form_modal"><span class="glyphicon glyphicon-plus"></span> Add User</button>
        <br /><br />
            ...
            <tbody>
                ...
                ?>  
                    <tr class="del_user<?php echo $fetch['user_id']?>">
                        ...
                        <td><center><button class="btn btn-primary" data-toggle="modal" data-target="#edit_modal<?php echo $fetch['user_id']?>"><span class="glyphicon glyphicon-edit"></span> Edit</button> 
                        <?php
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Firstname"  type="hidden" name="user_id" value="<?php echo $fetch['user_id']?>"/>
                                                <input type="text" name="firstname" value="<?php echo $fetch['firstname']?>" class="form-control" required="required"/>
                                            </div>
                                            <div class="form-group">
                                                <!-- <label>Lastname</label> -->
                                                <input placeholder="Lastname" type="text" name="lastname" value="<?php echo $fetch['lastname']?>" class="form-control" required="required"/>
                                            </div>
                                            <div class="form-group">
                                                <!-- <label>Username</label> -->
                                                <input placeholder="Username" type="text" name="username" value="<?php echo $fetch['username']?>" class="form-control" required="required"/>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php
                                                    if($fetch['status'] != "administrator"){
                                                ?>
                                                    <input input placeholder="Status" type="text" name="status" value="Regular" class="form-control" readonly="readonly" required="required"/>
                                                <?php
                                                    }else{
                                                ?>
                                                    <input placeholder="Status" type="text" name="status" value="administrator" class="form-control" readonly="readonly" required="required"/>
                                                <?php
                                                    }
                                                ?>
                                            </div>
