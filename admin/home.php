...
<?php 
            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="home.php"><i class="material-icons">dashboard</i><span>Dashboard</span></a></li>
                    ...
                    <li class="nav-item">
                           ...
                           <a class="nav-link" href="employee.php"><i class="fa fa-user"></i><span>Employees</span></a>
                                
                                    <div style="height: 300px;"></div>

                                    <a class="nav-link" href="http://localhost:8012/360%20view%20hotel%20Management%20System/360%20view%20hotel%20Management%20System/index.php"><i class="fa fa-user"></i><span>Documents</span></a>

                                    <!-- <a class="nav-link" href="user.php"><i class="far fa-clipboard"></i>

                                        <span>Reports</span></a> -->


                                        <a class="nav-link" href="#"><i class="material-icons">backup</i><span>Back Up System</span></a>
                                    <a
                                ...
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">Username&nbsp;</span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar3.jpeg"></a>
                                    <div
                                        ...
                                        <a
                                            ...
                                            <a class="dropdown-item" href="logout.php"><i class="glyphicon glyphicon-log-out"></i>&nbsp;Logout</a></div>
                    </div>
                    </li>
                    </ul>
            </div>
        ...
        <div class="alert alert-primary" ><h3>Mission</h3></div> 
        <p style="color: black; font-size: 20px ;">To satisfy the demands and expectations of our guests with the highest level of hospitality services, with the highest level of kindness and maximum quality, to provide them with a consistently high level of service.</p>
        <div class="alert alert-primary"><h3>Vision</h3></div> 
        <p style="color: black; font-size: 20px ;">To be the best and highest quality hotel in the city.</p>
    </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <canvas id="doughnutChart" style="height: 100px; "> 
...
<div>
    <div class="row">
                    <div class="col">
                        <div>
                            <div>
                                ...
                                <p style="color: black; font-size: 20px ;">Employee attendance</p>
                    ...
                    <div class="col">
                        <div>
                            <div>
                               ...
                               <p style="color: black; font-size: 20px ;">Monthly income & expense</p>
            ...
            <div class="container my-auto">
                <div class="text-center my-auto copyright"><span>©Copyright 360 view hotel Management System 2022</span></div>
            </div>
        </footer>
...
var myLineChart = new Chart(ctxL, {
  ...
  var myLineChart = new Chart(ctxD, {
    type: 'doughnut',
    data: {
      labels: ["Dinith", "Gayantha", "Pasindu", "Kamani", "Sumana"],
      datasets: [{
        data: [80, 50, 100, 40, 60],
