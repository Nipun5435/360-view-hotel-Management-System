...
<html lang="en">
	<head>
		<title>Hotel File Management System</title>
		<meta charset = "utf-8" />
...
<body>
	...
	<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" style="background-color:#002759 ;">
		<div class="container-fluid">
			<label style="color: white;" class="navbar-brand">Hotel File Management System</label>




			<div class="dropdown pull-right" style="margin-top: 12px; float: right;">
					...
					<ul class="dropdown-menu">
						<li><a href="http://localhost:8012/360%20view%20hotel%20Management%20System/360%20view%20hotel%20Management%20System/admin/home.php">Dashboard</a></li>
						<li><a href="employee_update.php">Update Account</a></li>
			...
			<div class="panel-body alert-info" style="margin-top:45px;" >
	...
	<div class="col-md-4">
		<div class="panel panel-info" style="margin-top:20%; width: 100%; ">
			<div class="panel-heading">
				<h1 class="panel-title">Employee Information</h1>
			</div>
			<div class="panel-body">
				<h4>Employee ID: <label class="pull-right"><?php echo $fetch['stud_no']?></label></h4>
				...
				<hr style="border-top:1px dotted #ccc;"/>
				<h4>Job role: <label class="pull-right"><?php echo $fetch['yr&sec']?></label></h4>
				<hr style="border-top:1px dotted #ccc;"/>
				<h3>File</h3>
